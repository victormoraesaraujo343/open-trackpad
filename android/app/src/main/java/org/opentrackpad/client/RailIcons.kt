...
object RailIcons {
    ...
    private val PATHS = mapOf(
        ...
        "paste" to "M7.4 4.2H6a1.2 1.2 0 0 0-1.2 1.2v10.2A1.2 1.2 0 0 0 6 16.8h8a1.2 1.2 0 0 0 1.2-1.2" +
            "V5.4A1.2 1.2 0 0 0 14 4.2h-1.4M7.4 3.2h5.2v2.4H7.4z",
        ...
        "shot" to "M3.6 7.4V4.6a1 1 0 0 1 1-1h2.8M12.6 3.6h2.8a1 1 0 0 1 1 1v2.8" +
